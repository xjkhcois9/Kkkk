...
/*
  صفحة تسجيل الدخول يجب أن تعرض دائمًا نموذج الدخول،
  حتى لو كانت هناك جلسة سابقة محفوظة من زيارة قديمة.
  لذلك نسجّل الخروج من أي جلسة قديمة فور فتح هذه الصفحة.
*/
signOut(auth).catch(() => {});
